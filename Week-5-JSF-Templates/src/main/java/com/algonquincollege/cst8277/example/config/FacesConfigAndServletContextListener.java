 ...
 *
 */
package com.algonquincollege.cst8277.example.config;
...
public class FacesConfigAndServletContextListener implements ServletContextListener {
	...
	public void contextInitialized( ServletContextEvent sce) {
		...
		//Context parameters
		//http://what-when-how.com/Tutorial/topic-605lt008/JSF-and-HTML5-301.html
		...
		//JSF has the ability to cache Facelets. In order to update the cache, JSF performs periodic checks of Facelets views changes
