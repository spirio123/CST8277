...
@NamedQuery(name = MyQueriesConstants.STUDENT_CLUB_FIND_ALL, query = "SELECT distinct sc FROM StudentClub sc")
@NamedQuery(name = MyQueriesConstants.STUDENT_CLUB_FIND_BY_NAME, query = "SELECT distinct sc FROM StudentClub sc where sc.id = :param1")
@NamedQuery(name = MyQueriesConstants.STUDENT_CLUB_IS_DUPLICATE, query = "SELECT count(sc) FROM StudentClub sc where sc.name = :param1")
