...
public class CourseResource {
	...
	public Response deleteCourse(@PathParam(RESOURCE_PATH_ID_ELEMENT) int id) {
		...
		if (course == null) {
			HttpErrorResponse err = new HttpErrorResponse(Status.CONFLICT.getStatusCode(), "Entity not found.");
	...
	public Response getCourseById(@PathParam(RESOURCE_PATH_ID_ELEMENT) int id) {
		...
		Course course = service.getById(Course.class, MyQueriesConstants.COURSE_FIND_BY_ID, id);
		if (course == null) {
